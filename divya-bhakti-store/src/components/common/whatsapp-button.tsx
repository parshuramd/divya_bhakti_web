...
export function WhatsAppButton({
    ...
    message = 'Hi! I\'m interested in your devotional products. Can you help me?',
}: WhatsAppButtonProps) {
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
            ...
            {showTooltip && (
                <div className="relative animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-3 pr-8 max-w-[220px]">
            ...
            <button
                onClick={handleClick}
                className={cn(
                    'group h-14 w-14 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95',
